...
public class FileConstant {
    ...
    //apk的下载路径
    public static final String DIR_APP = DIR_ROOT_BASE + DIR_ROOT_NAME + File.separator + "app";
    //闪退文件的保存路径
    public static String DIR_CRASH = DIR_ROOT_BASE  + DIR_ROOT_NAME + File.separator + "crash";
}
