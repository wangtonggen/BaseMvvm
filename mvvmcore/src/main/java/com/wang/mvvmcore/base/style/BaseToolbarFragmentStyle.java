 ...
 */
public class BaseToolbarFragmentStyle{
    ...
    public ObservableField<String> title = new ObservableField<>("标题");//标题
    ...
    public BaseToolbarFragmentStyle(BaseFragment fragment) {
