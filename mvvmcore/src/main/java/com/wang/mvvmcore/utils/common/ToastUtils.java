...
public class ToastUtils {
    ...
    public static void showLongToast(String content) {
        showLongToast(BaseCoreApplication.instance, content);
    }
    ...
    public static void showShortToast(String content) {
        showShortToast(BaseCoreApplication.instance, content);
    }
    ...
    public static void showShortToast(@StringRes int resId) {
        showShortToast(BaseCoreApplication.instance, resId);
    }
