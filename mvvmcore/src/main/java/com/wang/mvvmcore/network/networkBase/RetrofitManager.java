...
import static com.wang.mvvmcore.network.networkBase.ApiConfigConstant.READ_TIMEOUT;
import static com.wang.mvvmcore.network.networkBase.ApiConfigConstant.WRITE_TIMEOUT;
    ...
    public void init() {
        ...
        if (okHttpClient == null) {
            ...
            builder.readTimeout(readTimeout, readTimeoutTimeUnit)
                    ...
                    //添加下载拦截器
                    .cookieJar(new PersistentCookieJar(new SetCookieCache(), new SharedPrefsCookiePersistor(BaseCoreApplication.instance)));
